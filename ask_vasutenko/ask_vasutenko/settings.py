...
SECRET_KEY = "django-insecure--evsfx@4o(u%q=psp*um_h(vj)taq%v+8rs+9vjwf==!9nu^sq"
...
ROOT_URLCONF = "ask_vasutenko.urls"
...
WSGI_APPLICATION = "ask_vasutenko.wsgi.application"
